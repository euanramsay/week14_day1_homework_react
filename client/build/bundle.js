	...
	var MovieBox = React.createClass({
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement(MovieList, { comments: this.state.data })
	    );
	  }
	});
	...
	var MovieList = React.createClass({
	  ...
	  render: function render() {
	    ...
	    var movieComponents = this.props.movies.map(function (movieObject) {
	      return React.createElement(
	        Movie,
	        { name: movieObject.name, key: movieObject.id },
	        movieObject.name
	      );
	    });
	...
	var Movie = React.createClass({
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement(
	        'a',
	        { className: 'movie-name', href: this.props.url },
	        this.props.name
	      ),
	      React.createElement(
	        'a',
	        { className: 'movie-showtimes', href: this.props.showTimesURL },
	        'SHOWTIMES'
	      )
	    );
	  }
